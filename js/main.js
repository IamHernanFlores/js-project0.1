$(document).ready(function(){
	...
	if(window.location.href.indexOf('index') > -1){
	  ...
	  $('.galeria').bxSlider({ //JSON con as opciones y el metodo bxSlider 
	    mode: 'fade', // tipo de animacion 
	    captions: false,
	    slideWidth: 1200, // el tamaño, y en css cambiar mas
	    responsive: true, //muestra los puntos  page: true
	    pager: true
	  });
	...
	if(window.location.href.indexOf('index') > -1){
		var posts = [
			{
				title: 'Prueba de titulo 1',  // con el cdn moment js pasar de  date: new Date(), a uno especificando cada elemento, año mes hora.
		...
		posts.forEach((item, index) => {
			...
			`;
// JQuery para seleccionar el elemento
